            ...
            try
            {
                ...
                if(context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
                {
                    ...
                    if(context.MessageName.ToLower()=="create" && context.Stage ==40)
                    {
                        ...
                        {
                            coursefees = ((Money)(entity.Attributes["ss_coursefees"])).Value;
                        ...
                        studentEntity.Attributes["ss_name"] = firstName+DateTime.Now.Date;
                        ...
                        Guid recordGuid=service.Create(studentEntity);
                        tracingService.Trace("Record Guid:" + recordGuid);
                    }
                }
            }
            catch(Exception ex)
